...
#' @export
#' @export
rangeAreaCategoricalRaster=function(someRaster,catNames=NULL,cbsDir,scenario,sp.ind,cell.ind, mc.cores=1){
	...
	out=rangeAreaInBinaryStack(someRaster2,cbsDir=cbsDir,scenario=scenario, sp.ind=sp.ind, cell.ind=cell.ind,mc.cores=mc.cores)
