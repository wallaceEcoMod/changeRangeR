...
It is often useful to spatially quantify biodiversity data to assess geographically where patterns exist. For example, to find the areas that contain more than 50% of species richness, thresholding a raster by a statistical value can be important.
...
```{r}
PAs <- st_read("inst/extdata/DemoData/shapefiles", "WDPA_COL_olinguito")
# View the fields
colnames(PAs)
