...
```{r}
# Load shapefile
shp1 <- st_read("inst/extdata/DemoData/shapefiles", "WDPA_COL_olinguito")
# load raster
r <-raster("inst/extdata/DemoData/SDM/olinguito/Forest_suitable_projected1.tif")
# Reproject shapefile to CRS of projected raster
shp1 <- st_transform(shp1, crs(r))
...
# Plot
plot(x = future.ratios[,2], y = years, type = "b", main = "Percent of SDM predicted to be protected")
```
