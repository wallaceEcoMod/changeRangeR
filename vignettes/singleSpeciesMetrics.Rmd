...
ratio.Overlap <- ratioOverlap(r = r, shp = shp, field = field, category = category, subfield = T)
...
```{r}
binaryRange <- raster::raster(paste0(system.file(package="changeRangeR"), "/extdata/DemoData/SDM/olinguito/Climatically_suitable_projected1.tif"))
